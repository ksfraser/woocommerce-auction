...
Description: With<code><strong> YITH Auctions for WooCommerce</strong></code>, your customers can purchase products at the best price ever taking full advantage of the online auction system as the most popular portals, such as eBay, can do. <a href="https://yithemes.com/" target="_blank">Get more plugins for your e-commerce on <strong>YITH</strong></a>.
Author: YITH
...
/* === DEFINE === */
! defined( 'YITH_WCACT_VERSION' )            && define( 'YITH_WCACT_VERSION', '1.2.4' );
